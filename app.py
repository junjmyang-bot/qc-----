...
# --- 3. 데이터 로직 및 세션 상태 (에러 해결: 초기화 누락 방지) ---
...
if 'qc_store' not in st.session_state:
    ...
    st.session_state.a4_ts = [] # A-4 타임스탬프 저장소
    st.session_state.a8_logs = [] # A-8 로그 저장소 (AttributeError 해결 지점)
